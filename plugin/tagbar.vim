...
function! s:MapKeys()
    ...
    nnoremap <script> <silent> <buffer> +        :call <SID>ToggleFold()<CR>
    nnoremap <script> <silent> <buffer> <kPlus>  :call <SID>ToggleFold()<CR>
...
"    nnoremap <script> <silent> <buffer> zc       :call <SID>CloseFold()<CR>
    nnoremap <script> <silent> <buffer> o        :call <SID>OpenFold()<CR>
...
"    nnoremap <script> <silent> <buffer> zM   :call <SID>SetFoldLevel(0)<CR>
    ...
    nnoremap <script> <silent> <buffer> c    :call <SID>ToggleSort()<CR>
    nnoremap <script> <silent> <buffer> w    :call <SID>ZoomWindow()<CR>
    nnoremap <script> <silent> <buffer> x    :call <SID>CloseWindow()<CR>
...
"        silent 0put ='\" Press h for help'
        setlocal statusline='Press\ h\ for\ help'
"        silent  put _
    elseif !s:short_help
        ...
        silent  put ='\" <F2>      : Toggle tagbar'
        silent  put ='\" <S-t>     : Open for close tagbar'
        silent  put ='\"'
        silent  put ='\" ---------- Folds ----------'
        silent  put ='\" +         : Toggle fold'
        silent  put ='\" -         : Close fold'
        silent  put ='\" o         : Open fold'
        silent  put ='\" *         : Open all folds'
        silent  put ='\" =         : Close all folds'
        silent  put ='\"'
        silent  put ='\" ---------- Misc -----------'
        silent  put ='\" c          : Toggle sort'
        silent  put ='\" w          : Zoom window in/out'
        silent  put ='\" x          : Close window'
        silent  put ='\" h          : Remove help'
        silent  put _
    endif
endfunction
